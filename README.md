<h1>境界データのJSONです。</h1>
Python等で本ページのJSONデータを読み込む際は「raw」ボタンを押した際に表示されるURLをご利用ください。
<h2>①nakano_ku_85cho.json</h2>
<p>中野区85町丁別の境界データのgeojsonです。<br>ご自由にお使いください。ただし、コードを使って生じたいかなる問題にも責任を負いません。</p>
<p>出典は「政府統計の総合窓口（<a href="https://www.e-stat.go.jp/gis">ｅ－Ｓｔａｔ</a>）／地図で見る統計(統計GIS)／境界データ」です。<br>ダウンロードしたShapeファイルを加工して作成しました。なお、加工データをGitHubにアップロードする旨については出典元へ問い合わせしております。</p>
<p>加工内容は、ShapeファイルをPythonのpyshpで読み込み後、エディタで括弧等の修正を行いjson形式にし、ファイルサイズを小さくするために、CITY_NAME、KEYCODE1、緯度経度以外を削除し、「right-hand rule」ツールで変換しました。</p>
...
<p>[2022/9/20追記] PyScriptで読み込めるように、スペースと改行を削除して1行にまとめました。</p>
<h2>②nakano_ku_18cho.json</h2>
<p>中野区18町別の境界データのgeojsonです。https://geojson.io/ で手書きしました。手書きなので、細部は荒いです。</p><p>ご自由にお使いください。ただし、コードを使って生じたいかなる問題にも責任を負いません。</p>
<p>[2022/9/19追記] PyScriptで読み込めるように、スペースと改行を削除して1行にまとめました。</p>
<h2>③Nakano_ku.json</h2>
<p>中野区の境界データのgeojsonです。https://geojson.io/ で手書きしました。手書きなので、細部は荒いです。</p><p>ご自由にお使いください。ただし、コードを使って生じたいかなる問題にも責任を負いません。</p>
<p>[2022/9/19追記] PyScriptで読み込めるように、スペースと改行を削除して1行にまとめました。</p>
<h2>④Nakano_ku_school_district.json</h2>
<p>中野区の小学校区の境界データのgeojsonです。一部要修正。https://geojson.io/ で手書きしました。手書きなので、細部は荒いです。</p><p>ご自由にお使いください。ただし、コードを使って生じたいかなる問題にも責任を負いません。</p>
