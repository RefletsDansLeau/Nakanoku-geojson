<h1>境界データのJSONです。</h1>
URLから読み込む際は「raw」ボタンを押した際に表示されるURLをご利用ください。
...
<p>中野区の境界データのgeojsonです。https://geojson.io/ で手書きしました。手書きなので、細部は荒いです。</p><p>ご自由にお使いください。ただし、コードを使って生じたいかなる問題にも責任を負いません。
<p>[2022/9/19追記] PyScriptで読み込めるように、スペースと改行を削除して1行にまとめました。</p>
